...
const LeftNavPagesFollow = () => {
    return (
        <div>
            ...
            >
                <TextField id="standard-basic" label="Suggested for you" variant="standard" />
            </Box>
            <div className={styles.pages}>
                ...
                <Box
                    ...
                    noValidate
                    autoComplete="off"
                    className={styles.titleLiked}
                >
                    <TextField id="standard-basic" label="Liked pages" variant="standard" />
                </Box>
