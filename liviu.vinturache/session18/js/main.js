/**
 * Scope - spatiul unde variabilele unde sunt plasate in paranteze {}, daca nu avem paranteze
 * sunt declarate la nivel global, daca sunt in paranteze {} sunt variabile locale, functii, obiecte, array-uri...
 * putem avea access la o varibila din afara parantezei { } dar daca o refolosim sau redeclaram in interiorul parantezelor {} ea isi modifica valoarea doar din interiorul parantezelor nu si din exterior
 * functiile sau denumirile functiile se comporta similar cu varibilele declarate cu var
 * o functie de tipul fara const sau let poate fi apelata inainte sa fie declarata - se numeste Hoisting
 * orice cod scris dupa return nu se aplica!!!!
 */
...
const rateFood = (food) => {
    switch (food) {
        case 'Cartofi prajiti':
            console.log('Mancarea e de nota 10');
            break;
        case 'Gratar':
            console.log('Mancarea e de nota 9');
            break;
        default:
            console.log('Introdu mancarea preferata')
    }
}
rateFood('Cartofi prajiti')
rateFood('Gratar')
rateFood();
