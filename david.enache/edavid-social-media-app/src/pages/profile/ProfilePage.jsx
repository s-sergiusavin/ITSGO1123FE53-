    ...
    return (
      <div className="edit-profile-menu">
        <ul>
          ...
          <li>
            <Link to="/Change-profile-image" className="menu-item">
              Change profile image
            </Link>
          </li>
          <li>
            <Link to="/Change-cover-photo" className="menu-item">
              Change cover photo
            </Link>
          </li>
          <li>
          ...
          <li>
            <Link to="/privacy-settings" className="menu-item">
              Privacy Settings
            </Link>
          </li>
        </ul>
  ...
  return (
    <div className="profile-page-container">
      ...
      <div className="Buttons">
        <Button variant="contained" onClick={toggleStory}>
          Add to Story
        </Button>
